...
challenges = [
    ...
    ('blind-notice', '비문 공지 검색소', '공지 검색', '중상급', 340, '/challenges/blind-notice.php', '검색어가 조회문에 들어가는 방식을 관찰해 비공개 작전 메모의 인증 표식을 추적하십시오.', 1, 20),
    ('reflected-board', '반사 게시판 검색', 'DOM XSS', '초급', 180, '/challenges/reflected-board.php', '검색 결과 렌더링 흐름을 악용해 브라우저 alert 호출을 발생시키십시오.', 1, 25),
    ('image-vault', '영상 보급창', '보급창', '중급', 260, '/challenges/image-vault.php', '영상 보급창의 파일명 검문 규칙을 우회해 내부 보관 자료를 열람하십시오.', 1, 30),
    ('idle-empire', '코인 제국 보급 작전', '보급 자산', '중급', 260, '/challenges/idle-empire.php', '브라우저 저장소와 최종 보고 요청을 분석해 클라이언트 신뢰 취약점을 확인하십시오.', 1, 35),
    ('mission-report', '작전 보고서 열람소', '접근 제어', '중급', 280, '/challenges/mission-report.php', '보고서 번호를 직접 바꾸어 비공개 작전 보고서에 접근하십시오.', 1, 36),
...
flags = [
    ...
    ('image-vault', 'FLAG{Iz10MXMwOSZrMjBlb2M}'),
    ('idle-empire', 'FLAG{idle_empire_client_trust_bypass}'),
    ('mission-report', 'FLAG{cDgkb2FfdDE5MV9ycjQ}'),
